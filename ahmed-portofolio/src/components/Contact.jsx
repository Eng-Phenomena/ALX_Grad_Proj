    ...
    <section className="" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                Got a bold idea or a project in the works? Let’s connect! I’m always eager to collaborate and bring innovative embedded systems and digital designs to life.                </p>

                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({ href, icon}, key) => (
                        <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rouunded-lg transition-[background-color,color] hover:bg-zinc-50 hover:tetx-zinc-950 active:bg-zinc-50/80"> 
                            {icon} 
                        </a>
                    ))}
                </div>
            </div>
            <form action="https://getform.io/f/ajjeklda" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Ahmed Hossam" className="text-field"/>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="ahmed@gmail.com" className="text-field"/>
                    </div>
                </div>
